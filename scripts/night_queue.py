...
MODELS = [
    ...
    ("qwen3.5-4b-q4_K_M", "/mnt/data/models/qwen3.5-4b/Qwen3.5-4B-Q4_K_M.gguf", "32768", "2", "LLAMA"),
    ("sharp-spark-4b-q4_K_XL", "/mnt/data/models/sharp-spark-4b/Sharp-Spark-X2.5-4B-Q4_K_XL.gguf", "32768", "2", "LLAMA"),
    ("lfm2.5-2.6b-q4_K_M", "/mnt/data/models/lfm2.5-2.6b/LFM2.5-2.6B-Q4_K_M.gguf", "32768", "2", "LLAMA"),
    ("lfm2.5-2.6b-q8_0", "/mnt/data/models/lfm2.5-2.6b/LFM2.5-2.6B-Q8_0.gguf", "32768", "2", "LLAMA"),
    ("gemma-e4b-q4_K_M", "/mnt/data/models/gemma-e4b/gemma-3n-E4B-it-Q4_K_M.gguf", "16384", "1", "LLAMA"),
    ("mimo-9b-q4_K_M", "/mnt/data/models/mimo-9b/MiMo-V2.6-Distill-Qwen-9B-Q4_K_M.gguf", "8192", "1", "LLAMA"),
    ("ornith-9b-q4_K_M", "/mnt/data/models/ornith-9b/Ornith-1.5-9B-Q4_K_M.gguf", "8192", "1", "LLAMA"),
    ("gemma4-e4b-q4_K_M", "/mnt/data/models/gemma4-e4b/google_gemma-4-E4B-it-Q4_K_M.gguf", "32768", "2", "LLAMA"),
    ("gemma4-12b-ud-q2_K_XL", "/mnt/data/models/gemma4-12b/gemma-4-12b-it-UD-Q2_K_XL.gguf", "16384", "1", "LLAMA"),
    ("gemma4-12b-iq3_XXS", "/mnt/data/models/gemma4-12b/gemma-4-12B-it-IQ3_XXS.gguf", "16384", "1", "LLAMA"),
    ("bonsai2-ptq1_0", "/mnt/data/models/bonsai-2/Ternary-Bonsai-2-27B-PTQ1_0.gguf", "8192", "1", "PRISM"),
]
...
def swap_server(name, path, ctx, np_, binary):
